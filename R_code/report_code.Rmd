...
test.pca <- prcomp(st_test[,1:30])
st_test_dimred <- data.frame("PCA1"=test.pca$x[,1],"PCA2"=test.pca$x[,2],"PCA3"=test.pca$x[,3])
st_test_dimred["Label"] <- st_test$Label

probabilities <- predict(logreg_weighted_pca$finalModel, st_test_dimred[,1:3], type = "response")
